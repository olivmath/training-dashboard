...
export const BIKE_WEEKS_7_8: Record<string, Workout> = {
  'b7-seg': {
    name: 'Pedalada Leve', type: 'easy', week: 7, day: 'Terça',
  ...
  'b7-ter': {
    name: 'Descanso', type: 'rest', week: 7, day: 'Quarta',
    note: 'Descanso.',
    steps: [{ kind: 'rest', label: 'Descanso', metric: '—', zone: null }],
  },
  'b7-qua': {
    name: 'Tiros Curtos', type: 'intv', week: 7, day: 'Quinta',
  ...
  'b7-sab': {
    name: 'Leve + Sprints', type: 'easy', week: 7, day: 'Domingo',
  ...
  'b8-seg': {
    name: 'Pedalada Leve', type: 'easy', week: 8, day: 'Terça',
  ...
  'b8-ter': {
    name: 'Descanso', type: 'rest', week: 8, day: 'Quarta',
    note: 'Descanso total.',
    steps: [{ kind: 'rest', label: 'Descanso', metric: '—', zone: null }],
  },
  'b8-qua': {
    name: 'Ativação', type: 'easy', week: 8, day: 'Quinta',
  ...
  'b8-sab': {
    name: 'TIME TRIAL 10 km', type: 'race', week: 8, day: 'Domingo',
