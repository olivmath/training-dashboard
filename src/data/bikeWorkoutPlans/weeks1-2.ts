...
export const BIKE_WEEKS_1_2: Record<string, Workout> = {
  'b1-seg': {
    name: 'Pedalada Leve', type: 'easy', week: 1, day: 'Terça',
  ...
  'b1-ter': {
    name: 'Descanso', type: 'rest', week: 1, day: 'Quarta',
  ...
  'b1-qua': {
    name: 'Leve + Cadência', type: 'easy', week: 1, day: 'Quinta',
  ...
  'b1-sab': {
    name: 'Longo', type: 'long', week: 1, day: 'Domingo',
  ...
  'b2-seg': {
    name: 'Pedalada Leve', type: 'easy', week: 2, day: 'Terça',
    note: 'Recuperação ativa. Não force — a adaptação acontece no descanso.',
    steps: [
      { kind: 'warmup',   label: 'Aquecimento',   metric: '5 min',  zone: 1 },
  ...
  'b2-ter': {
    name: 'Descanso', type: 'rest', week: 2, day: 'Quarta',
    note: 'Descanso completo.',
    steps: [{ kind: 'rest', label: 'Descanso', metric: '—', zone: null }],
  },
  'b2-qua': {
    name: 'Tempo Curto', type: 'tempo', week: 2, day: 'Quinta',
  ...
  'b2-sab': {
    name: 'Longo', type: 'long', week: 2, day: 'Domingo',
