...
export const WEEKS_3_4: Record<string, Workout> = {
  's3-seg': {
    name: 'Tiros 400 m', type: 'intv', week: 3, day: 'Segunda',
  ...
  's3-qua': {
    name: 'Fácil', type: 'easy', week: 3, day: 'Sexta',
  ...
  's4-seg': {
    name: 'Tempo 3 km', type: 'tempo', week: 4, day: 'Segunda',
  ...
  's4-qua': {
    name: 'Fácil', type: 'easy', week: 4, day: 'Sexta',
