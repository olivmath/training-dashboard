...
export const WEEKS_1_2: Record<string, Workout> = {
  's1-seg': {
    name: 'Fácil + Strides', type: 'easy', week: 1, day: 'Segunda',
  ...
  's1-qua': {
    name: 'Fácil', type: 'easy', week: 1, day: 'Sexta',
  ...
  's2-seg': {
    name: 'Tempo Curto', type: 'tempo', week: 2, day: 'Segunda',
  ...
  's2-qua': {
    name: 'Fácil', type: 'easy', week: 2, day: 'Sexta',
    note: 'Trote de recuperação. Mantenha acima de 6:20/km.',
    steps: [
      { kind: 'warmup',   label: 'Aquecimento',    metric: '5 min',  zone: 1 },
      { kind: 'steady',   label: 'Corrida fácil',  metric: '20 min', zone: 2 },
      { kind: 'cooldown', label: 'Desaquecimento', metric: '5 min',  zone: 1 },
